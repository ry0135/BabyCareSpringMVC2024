...
public class PaymentController {
    ...
    @PostMapping("/submitUrlService")
    public void createPaymentService(HttpServletRequest request, HttpServletResponse response,
                              @RequestParam(required = false) String amount,
                              @RequestParam(required = false) String bankCode
        ...
        try {
            ...
            String locale = request.getParameter("language");
            vnp_Params.put("vnp_Locale", (locale != null && !locale.isEmpty()) ? locale : "vn");
            vnp_Params.put("vnp_ReturnUrl", vnpayService.vnp_ReturnUrlService);
            vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
