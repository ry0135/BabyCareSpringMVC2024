...
<div class="container ">
  ...
  <div class="  col-lg-11" id="basic-info" style="margin-left: 25px; margin-top: 25px;">
    <nav class="nav nav-pills nav-justified">
      ...
      <a class="nav-item nav-link active" style=" background-color: #ff4880; " href="listbookingAccept">Đơn hàng đã xác nhận</a>
    ...
    <table class="table table-bordered" id="data-table">
      ...
      <c:forEach var="order" items="${list}">
        <tr>
          ...
          <td><a href="succerbooking?id=${order.bookingID}" class="btn btn-success">Hoàn Thành</a></td>
