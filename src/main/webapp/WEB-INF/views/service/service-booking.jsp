            ...
            <div class="row gy-3 gx-4">
              <div class="col-md-6 offset-3 mb-3">
                ...
                <div class="input-group">
                  <input type="hidden" class="form-control" id="serviceID" name="serviceIMG" value="${serviceIMG}" aria-describedby="inputGroupPrepend" required>
                  <h1></h1>
              ...
              <div class="col-xl-6">
                <input type="text" class="form-control py-3 border-primary bg-transparent text-dark" placeholder="Địa chỉ" name="address" value="${address}" required>
              </div>
              <div class="col-xl-6">
