...
<div class="container ">
    ...
    <div class="  col-lg-11" id="basic-info" style="margin-left: 25px; margin-top: 25px;">
        <nav class="nav nav-pills nav-justified">
            <a class="nav-item nav-link  " href="#">Tài khoàn đăng ký dịch vụ</a>
            <a class="nav-item nav-link active " style=" background-color: #ff4880; " href="#">Cửa hàng đăng ký bán hàng</a>
        ...
        <table class="table table-bordered" id="data-table">
            ...
            <c:forEach var="brand" items="${listRegisterCTV}">
                <tr>
                    ...
                    <td>${brand.identifiNumber}</td>
                    <td>
                        <img src="${pageContext.request.contextPath}/image/${brand.identifiImg}" alt="Identifi Image" style="width: 100px; height: auto;">
                    </td>
                    <td>
                        <img src="${pageContext.request.contextPath}/image/${brand.identifiImgFace}" alt="Identifi Face Image" style="width: 100px; height: auto;">
                    </td>
                    <td>
                        <a href="https://masothue.com/" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Check Mã Số Thuế</a>
                    </td>


                    <td>
                        <a href="ApproveCTVOrder?CTVID=${brand.CTVID}" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Duyệt</a>
                    </td>
                    <td>
                        <a href="UnApproveCTVOrder?CTVID=${brand.CTVID}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Không Duyệt</a>
                    </td>
                </tr>
            </c:forEach>
