...
<div class="container ">
  ...
  <div class="  col-lg-11" id="basic-info" style="margin-left: 25px; margin-top: 25px;">
    <nav class="nav nav-pills nav-justified">
      ...
      <a class="nav-item nav-link active " style=" background-color: #ff4880; " href="#">Cửa hàng đăng ký dịch vụ</a>
    ...
    <table class="table table-bordered" id="data-table">
      ...
      <c:forEach var="shopservice" items="${listregistershopservicve}">
        <tr>
          ...
          <td>${shopservice.identifiNumber}</td>
          <td>
          ...
          <td>
            <a href="approveCTV?ctvID=${shopservice.ctvID}" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Duyệt</a>
          </td>
          <td>
            <a href="unApproveCTV?ctvID=${shopservice.ctvID}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Không Duyệt</a>
          </td>
        </tr>
      </c:forEach>
