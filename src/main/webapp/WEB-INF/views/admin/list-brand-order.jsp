...
<%--                    <td>--%>
<%--                        <a href="UnLockCTVOrder?CTVID=${brand.CTVID}" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Mở Khóa</a>--%>
<%--                    </td>--%>
<%--                    <td>--%>
<%--                        <a href="LockCTVOrder?CTVID=${brand.CTVID}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Khóa</a>--%>
<%--                    </td>--%>
                </tr>
            </c:forEach>
