...
<div class="container ">
  ...
  <table  class="table table-bordered" id="data-table">
    ...
    <tr>
      ...
      <td>
        <a href="approveProduct?productId=${product.productId}" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Duyệt</a>
      </td>
      <td>
        <a href="unApproveProduct?productId=${product.productId}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Không Duyệt</a>
      </td>
    </tr>
    </c:forEach>
    </div>
