    ...
    <div class="row g-5" id="productContainer">
      <c:forEach var="preferential" items="${preferentialList}">
        <div class="col-lg-2 col-md-4 col-sm-6 comment-item" style="margin-top: 12px;">
            ...
            <div class="product-item position-relative bg-white d-flex flex-column text-center ${preferential.quantity == 0 ? 'out-of-stock' : ''}">
              <div class="product-image">
                <img class="img-fluid" src="${pageContext.request.contextPath}/image/${preferential.preferentialImg}" alt="">
                <div class="out-of-stock" style="display: ${product.productAmount == 0 ? 'flex' : 'none'};">Hết hàng</div>
              </div>
              <div class="product-details">
                <h6 class="product-name">${preferential.preferentialName}</h6>
                <h5 class="text-primary mb-0 product-price">₫ ${preferential.getRate()}</h5>
              </div>
            </div>
        </div>
      </c:forEach>
