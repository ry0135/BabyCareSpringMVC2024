...
<div class="container ">
  ...
  <div class="  col-lg-11" id="basic-info" style="margin-left: 25px; margin-top: 25px;">
    <nav class="nav nav-pills nav-justified">
      ...
      <a class="nav-item nav-link active" href="#"style=" background-color: #ff4880;">Đơn hàng đã đánh giá</a>
      <a class="nav-item nav-link  " href="list-order-cancel">Đơn hàng đã hủy</a>

    </nav>


    <h2>Quản lí danh sách đặt hàng đã đánh giá</h2>
    <p>Nhân viên có thể xem được danh sách đặt hàng đã đánh giá</p>
