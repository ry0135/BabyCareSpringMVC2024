...
<div class="container-fluid pt-5 ">
  ...
  <div id="page-wrapper">
    ...
    <nav class="nav nav-pills nav-justified">
      <a class="nav-item nav-link " style="color : black; background: white" href="manage-emp-account">Danh sách tài khoản nhân viên</a>
      <a class="nav-item nav-link " style="color : white; background: #007bff" href="#">Thêm tài khoản nhân viên</a>
      ...
      <div class="container">
        ...
        <div class="row g-5">
          <div class="col-12">
            ...
            <form action="<c:url value=saveEmployee>" method="post" class="needs-validation" novalidate>
              ...
              <div class="row">
                <div class="col-3 offset-3">
                  <a class="nav-item nav-link " style="color : black; background: white" href="saveEmp">Đăng ký</a>
                </div>
