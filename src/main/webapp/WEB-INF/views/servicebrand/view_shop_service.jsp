        ...
        <div class="row">
            <div class="col-md-3">
                <div class="d-flex align-items-center mb-2">
                    <img style="width: 22%; height: 50%; border-radius: 50%;" src="${pageContext.request.contextPath}/image/${brand.brandLogo}" alt="${brand.brandName} Logo">
                    <h1>${brand.brandName}</h1>
                </div>
                <form action="chatMessage">
                    <input name="toId" type="hidden" value="${brand.ctvID}">
